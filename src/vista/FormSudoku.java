...
public class FormSudoku extends javax.swing.JFrame {
    ...
    public void iniciarComponentes() {
        ...
        tableroSudoku.setPanelBackground(new Color(255,0,153));//SUDOKU FONDO

        tableroSudoku.setTxtBackground1(new Color(246,161,202));
        tableroSudoku.setTxtForeground1(new Color(102,102,102));//NUMERO PUESTO
        tableroSudoku.setTxtBackground2(new Color(204,204,204));//AREA SELECCION
        tableroSudoku.setTxtForeground2(Color.BLACK);
        tableroSudoku.setTxtBackground3(new Color(251,145,197));//CAJITA SELECCIONADA
        tableroSudoku.setTxtForeground3(Color.WHITE);//NUMERO CAJITA SELECCIONADA
        tableroSudoku.setTxtBackground4(new Color(251,195,222));
        tableroSudoku.setTxtForeground4(Color.WHITE);
        ...
        tableroNumeros.setPanelBackground(new Color(255,0,153));//NUMEROS FONDO
        tableroNumeros.setTxtBackground1(new Color(246,161,202));//INTERIOR NUMEROS
        tableroNumeros.setTxtForeground1(new Color(255,255,255));//COLOR NUMEROS
        tableroNumeros.setTxtBackground2(new Color(255,0,153));//PUNTERO NUMEROS
        tableroNumeros.setTxtForeground2(Color.WHITE);//NUMEROS COLOR
    ...
    private void initComponents() {
        ...
        panelFondo.setBackground(new java.awt.Color(255, 102, 204));
        ...
        panelNuevaPartida.setBackground(new java.awt.Color(255, 0, 153));
        panelNuevaPartida.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));

        lblNuevaPartida.setBackground(new java.awt.Color(51, 255, 0));
        ...
        panelNuevaPartida.setBounds(420, 100, 150, 40);

        panelLimpiar.setBackground(new java.awt.Color(255, 0, 153));
        ...
        panelLimpiar.setBounds(420, 160, 150, 40);

        panelComprobar.setBackground(new java.awt.Color(250, 0, 153));
        panelComprobar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        panelComprobar.setBounds(420, 220, 150, 40);

        panelResolver.setBackground(new java.awt.Color(255, 0, 153));
        panelResolver.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        panelResolver.setBounds(420, 280, 150, 40);
    ...
    private void lblNuevaPartidaMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblNuevaPartidaMouseEntered
        panelNuevaPartida.setBackground(new Color(255,153,204));
    ...
    private void lblNuevaPartidaMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblNuevaPartidaMouseExited
        panelNuevaPartida.setBackground(new Color(255,0,153));
    ...
    private void lblLimpiarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblLimpiarMouseEntered
        panelLimpiar.setBackground(new Color(255,153,204));
    ...
    private void lblLimpiarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblLimpiarMouseExited
        panelLimpiar.setBackground(new Color(255,0,153));
    ...
    private void lblComprobarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblComprobarMouseEntered
       panelComprobar.setBackground(new Color(255,153,204));
    ...
    private void lblComprobarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblComprobarMouseExited
         panelComprobar.setBackground(new Color(255,0,153));
    ...
    private void lblResolverMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblResolverMouseEntered
         panelResolver.setBackground(new Color(255,153,204));
    ...
    private void lblResolverMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblResolverMouseExited
            panelResolver.setBackground(new Color(255,0,153));
